...
def main() -> None:
    ...
    # Initialize Services
    ingestion_service = ResearchIngestionService(scraper, storage)
    maintenance_service = WikiMaintenanceService(storage, llm)
    discovery_service = TickerDiscoveryService(storage, llm)
